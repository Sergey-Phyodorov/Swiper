function initializeSwiper() {
	new Swiper('.swiper', {
		...
		// #Если убрать slideChangeTransitionEnd и overflow: hidden; то можно будет скроллить страницу
		// #Так-же как и способ выше, но будет виден вертикальный скролбар браузера
